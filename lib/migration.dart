...
class MigrationHelper {
  ...
  static Future<void> migrate() async {
    ...
    // Старі ключі більше не потрібні, але НЕ видаляємо одразу —
    // залишаємо як резервну копію на 1 сесію.
    // При наступному запуску вони вже не використовуються.
  }

  /// Очистити старі SP-дані (можна викликати вручну або через налаштування)
  static Future<void> cleanupOldPrefs() async {
    final prefs = await SharedPreferences.getInstance();
